...
- **Capabilities** are the contracts (14 of them — see the
  [architecture spec](./docs/wiki/specifications/tech-architecture.spec.md)).
...
packages/
  ...
  holocron-plugin-cloudflare/     — @theholocron/holocron-plugin-cloudflare (dns)
  ...
  github-app/                     — @theholocron/github-app                 (minimal GitHub App — scaffolding only)
