...
vi.mock("./actions/lint-commits.js", () => ({ lintCommits: vi.fn() }));
vi.mock("./actions/post-check-run.js", () => ({ postCheckRun: vi.fn() }));
vi.mock("./actions/post-commit-standards-check.js", () => ({ postCommitStandardsCheck: vi.fn() }));
...
import { lintCommits } from "./actions/lint-commits.js";
import { postCheckRun } from "./actions/post-check-run.js";
import { postCommitStandardsCheck } from "./actions/post-commit-standards-check.js";
