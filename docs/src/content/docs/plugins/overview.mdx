...
| [`@theholocron/holocron-plugin-axiom`](./axiom)           | logs                                      | `HOLOCRON_AXIOM_TOKEN`                          |
...
| [`@theholocron/holocron-plugin-fern`](./fern)             | wiki                                      | `HOLOCRON_FERN_TOKEN` (CI secret — not keyring) |
...
| [`@theholocron/holocron-plugin-sentry`](./sentry)         | errors                                    | `HOLOCRON_SENTRY_TOKEN`                         |
