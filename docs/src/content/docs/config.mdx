...
export default defineConfig({
  ...
  // package.json scripts `holocron sync` keeps current. Only these keys are
  // reconciled (merge, not clobber) — every other script is left alone.
  scripts: { holocron: "holocron" },
