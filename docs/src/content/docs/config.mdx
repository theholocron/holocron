...
export default defineConfig({
  ...
  // Structured-logging config — level only. Lowest-priority level source:
  // --verbose/--quiet and HOLOCRON_LOG_LEVEL both outrank it. Axiom
  // credentials never live here; they come from env vars.
  log: { level: "info" },
});
```
